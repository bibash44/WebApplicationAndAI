    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <p>
                    <a href="./additems.jsp"
                       style="background-color: green; color: white; padding: 10px; border-radius: 2px;">Add
                        items <span> <i class="fa fa-plus"></i></span>
                    </a>
                </p>
                <br>
                <p>
                    <a href="viewallitems"
                       style="background-color: rgb(0, 60, 128); color: white; padding: 10px; border-radius: 2px;">Edit
                        items <span> <i class="fa fa-pencil"></i></span>
                    </a>
                ...
                <br>
                <p>
                    <a href="viewordersbyadmin"
                       style="background-color: black; color: white; padding: 10px; border-radius: 2px;">View orders
