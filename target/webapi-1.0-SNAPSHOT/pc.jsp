...
<head>
    ...
    <title>COMPUTER FOR YOU | PC</title>
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li class="active"><a href="./pc.jsp">PC</a></li>
                ...
                <div class="col-lg-4">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            <h6>Acer Nitro 5 2020 i5 10TH GEN / RTX 2060 / 16GB RAM / 256GB SSD / 1TB HDD / 15.6" FHD / RGB Keyboard</h6>
