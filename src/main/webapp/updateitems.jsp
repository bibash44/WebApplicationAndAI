                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            ...
                            <input type="text" name="productname" value="<%=productname%>" id="productname"  required placeholder="Eg: Acer Nitro"
                    ...
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            <p>CPU <span>*</span></p>
                            <input type="text" name="cpu" value="<%=cpu%>"  id="cpu"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            ...
                            <input type="text" name="processor" value="<%=processor%>" id="processor" required placeholder="Eg: 4 Core">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            <p>Graphics <span>*</span></p>
                            <input type="text" name="graphics" value="<%=graphics%>"  id="graphics"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            ...
                            <input type="text" name="display" value="<%=display%>" id="display"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            ...
                            <input type="text" name="memory" value="<%=memory%>" id="memory" required placeholder="Eg: 16GB DDR4 2933MHz Memory">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            <p>Storage <span>*</span></p>
                            <input type="text" name="storage" value="<%=storage%>" id="storage" required placeholder="256Gb SSD +1TB HDD">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            ...
                            <input type="text" name="power" value="<%=power%>" id="power" required placeholder="Eg: 180 watt / 330 watt power supply">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="checkout__input">
                            <p>Weight (in kg) <span>*</span></p>
                            <input type="number" value="<%=weight%>" name="weight" id="weight" required placeholder="1 Kg">
                        </div>
                    </div>
                </div>
