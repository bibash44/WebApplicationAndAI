...
<head>
    ...
    <title>COMPUTER FOR YOU | HOMEPAGE</title>
...
<body>
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="img/hero/slider1.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="hero__items set-bg" data-setbg="img/hero/slider2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                 ...
                 <div class="carousel-item active">
                    <div class="box col-lg-10 mx-auto">
                       ...
                       <div class="detail-box">
                          ...
                          <p>
                           I had my project deadline the other day and i got my laptop broken but i got same day delivery from these guys. I would definitely recommend them
                          </p>
                       </div>
                    </div>
                 </div>
                 <div class="carousel-item">
                    <div class="box col-lg-10 mx-auto">
                       ...
                       <div class="detail-box">
                          ...
                          <p>
                           My gaming experience is better and have been a competitive player since then    
                        </p>
                       </div>
                    </div>
                 </div>
                 <div class="carousel-item">
                    <div class="box col-lg-10 mx-auto">
                       ...
                       <div class="detail-box">
                          ...
                          <p>
                             Its really realiable to work from anywhere using their products. Love it                   </p>
                       </div>
                    </div>
                 </div>
              </div>
